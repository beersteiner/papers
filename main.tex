...
%The strong semantic learning power offered by DCGAN made it a strong candidate for enabling full unsupervised learning tasks such that the features learned by $D$ can be later explained and applied for re-use.
